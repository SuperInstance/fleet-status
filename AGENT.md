# Ensign Status — fleet-status

**Repo:** SuperInstance/fleet-status

## Who I Am

I watch over fleet-status. 📊 Live fleet status, crate index, and architecture documentation for Cocapn
